  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--bg)" }}>
      ...
      <section style={{
        ...
        <div style={{ position: "relative", zIndex: 1, display: "flex", alignItems: "center", gap: 80, width: "100%", maxWidth: 1200, margin: "0 auto" }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <h1 style={{ fontFamily: "var(--font-playfair), serif", lineHeight: 1.05, marginBottom: 28 }}>
            ...
            <p style={{ fontSize: 16, color: "var(--muted)", maxWidth: 440, lineHeight: 1.75, marginBottom: 40, fontWeight: 400 }}>
            ...
            <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
              ...
              <a href="mailto:sachio.chan@binus.ac.id" className="btn-primary" style={{ background: "var(--mint)", color: "var(--mint-dk)" }}>
          ...
          <div style={{ flexShrink: 0, position: "relative" }}>
            ...
            <div style={{
              ...
              <div style={{ width: 8, height: 8, borderRadius: "50%", background: "var(--mint-dk)", flexShrink: 0 }} />
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 72, alignItems: "center" }}>
            <div>
              ...
              {personal.bio.map((para: string, i: number) => (
                <p key={i} style={{ fontSize: 15, color: "var(--muted)", lineHeight: 1.8, marginBottom: 12, fontWeight: 400 }}>
                  {para}
                </p>
              ))}
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
              {aboutTiles.map((tile: Tile) => (
                <div key={tile.label} style={{
                  ...
                  <div style={{ fontSize: 28, marginBottom: 10 }}>{tile.emoji}</div>
      ...
      {/* ── SKILLS ── */}
      <section style={{ padding: "80px 64px", background: "var(--ink)", borderRadius: "0 0 0 0" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80 }}>
            ...
            <div style={{
              ...
              <div>
                ...
                <input className="contact-input" placeholder="Jane Smith" />
              </div>
              <div>
                <label style={{ fontSize: 11, fontWeight: 700, color: "var(--ink)", letterSpacing: "0.06em", textTransform: "uppercase", display: "block", marginBottom: 8 }}>
                  Email
                </label>
                <input className="contact-input" placeholder="jane@company.com" />
              </div>
              <div>
                <label style={{ fontSize: 11, fontWeight: 700, color: "var(--ink)", letterSpacing: "0.06em", textTransform: "uppercase", display: "block", marginBottom: 8 }}>
                  Message
